...
export const MainTimerDisplay: React.FC<MainTimerDisplayProps> = React.memo(({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center w-[250px] h-[250px] xs:w-72 xs:h-72 sm:w-80 sm:h-80 md:w-88 md:h-88 xl:w-96 xl:h-96">
        ...
        <div className="flex flex-col items-center justify-center text-center z-10 p-2 sm:p-6">
          {/* Mode Pill Label */}
          <div
            className={`px-3 py-1 mb-1.5 sm:mb-2 rounded-full text-[10px] sm:text-[11px] tracking-widest uppercase font-medium border transition-all duration-300 ${
              isCompleted
                ? isLight
          ...
          <div
            className="font-timer text-[44px] xs:text-5xl sm:text-7xl md:text-8xl font-bold tracking-tight drop-shadow-2xl my-0.5 sm:my-1 select-none transition-colors duration-300 leading-none"
