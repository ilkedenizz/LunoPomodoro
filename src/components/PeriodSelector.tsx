...
export const PeriodSelector: React.FC<PeriodSelectorProps> = ({ period, onChangePeriod }) => {
        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`px-3.5 sm:px-5 py-1.5 rounded-xl text-xs font-medium transition-all duration-300 whitespace-nowrap focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 ${
                isActive
